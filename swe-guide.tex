...
% There might be many reasons, depending on who you are. <List reasons here?> However, there is a more general reason...
...
% As technology gets more complicated, it gets harder to fully understand. If you see yourself utilizing computers frequently for the remainder of your life, the time to learn about them is now.
...
This curiosity aside, we could also design our category system such that quantities and qualities are considered \textit{properties} of \textit{objects}. 
...
% Descartes founds the mechanistic philosophy that early models adhere to.
...
% Categorization is a useful tool for orienting yourself, but it is possible to go too far down the rabbit hole. You cannot seperate reality into neat little piles. I can show you green, and I can show you blue, but there is an infinite number of colors in between.
