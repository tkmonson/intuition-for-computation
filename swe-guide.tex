...
\begin{center}
	\textit{\textbf{Data} is super fun and stuff}
\end{center}

% The four words. Trust your gut.
% Knowledge is "true beliefs"

% Symbols represent objects, but they are not the objects. Map-territory relation.
...
% General ideas are hard to grasp. Information is very general. We are going to approach it in a multi-disciplinary way.

\subsection{Categories of Being}

% Describe chaos, pure perception with no thought, no categories, just raw reality. Quality. Qualia. Experience. Truth.
% First thoughts
% "I know nothing of baby psychology."
% Get a definition of system in here somewhere?
% What is a category? Philosophy and math.
% Important: is there a most general category?
% If so, thing is the most general category (provides no information). And an object is any thing that is suitable for thought ("thing presented to the mind"). Are all things objects? Who the fuck knows. Let's assume yes.
...
\subsubsection{Taxonomies and Ontologies}
