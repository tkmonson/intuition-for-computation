...
% This document uses A4 paper size. Print it out and put some staples in it if you would like a hard copy.
...
Regardless, the namers must reach outside of the formalisms they have constructed and find a word from an informal language that captures the essence of their abstract thought. This is the beauty of good technical jargon: such a word will, to an amateur, shed a shallow but wide light into the vast space of an idea, but it will also illuminate the whole shebang in the eyes of an expert, evoking in its concise informality all that he or she has previously learned on the subject. \\
...
\begin{displayquote}
	\textit{
		...
		\textbf{Knowledge} is the meaning interpreted from information by an interpreter. It is usually associated with Truth and may be considered a body of true beliefs. \\~\\
...
In addition to these four fundamental terms, there are a few ideas that are worth bringing up here due to just how pervasive they are in all of the content beyond this point. Each one refers to a \textit{metaphysical distinction}, a categorizing of what we observe. These themes are deserving of regular reflection as they will come up often in our discussion of computation: \\

\begin{enumerate}
	\item The \textbf{abstract-concrete dichotomy} is a division that classifies things as being either \textit{abstract} or \textit{concrete}. Despite the fact that most people recognize a difference between an abstract and a concrete thing, this dichotomy does not have a universally accepted definition. That said, being abstract is often defined as being both \textit{non-spatiotemporal} and \textit{causally inefficacious}. That is, something is abstract if and only if it does not exist in space and time (or in spacetime) and does not \textit{cause} any \textit{effect}. \\
	
	However, one might argue that nothing is causally inefficacious. \\
	
	\item The \textbf{map-territory relation} \\
	
	\item Languages can be described in terms of their \textbf{syntax, semantics, and pragmatics}. \\
	
	\item The \textbf{type-token distinction} \\
	
	\item \textbf{Mind-body dualism} \\
\end{enumerate}

% Abstract-concrete. Are there abstract things at all (nominalism)? Is chess an abstract object? Is a novel an abstract object?
	% Causality.
...
% Syntax-semantics-pragmatics.
	% Syntax includes grammar, phonology, and orthagraphy.
	% Extension-intension.
	% Truth-falsity.
...
% Mind-body dualism.
	...
	% Subject vs object.
	% Perception vs. reality. Phenomena and noumena.

% Domain of discourse. Open and closed world. System.

% The chaos is unorganized data. Neural processing structures data into information. A semantic interpretation turns info into knowledge. An interpretation is strong if it is agreed upon. A category system is an interpretation of reality, a firm partitioning of some phenomena from others.
...
% First thoughts
% "I know nothing of baby psychology."
...
% HUGE POINT: An object consists of a type and a structure. A type is what the object is semantically. What does the object mean? A structure is what the object is syntactically. What is the object
...
%--------------------------------------------------------------------------------
%--------------------------------------------------------------------------------
%    PART VII: TOOLS AND TECHNOLOGIES
%--------------------------------------------------------------------------------
%--------------------------------------------------------------------------------
...
% The world has a chatroom. We can talk to people we will never meet and see perspectives we would never would have seen otherwise.
...
% Teaching syntax over semantics. Anecdote of the dot product. Feeling like things are there for no reason. Math ideas are not invented out of thin air, and they shouldn't be taught that way. They are invented for a convenient purpose, and we should be teaching the history of their original purpose before generalizing it for use in other applications. This also allows us to understand the original assumptions that were made while constructing the model and thus whether or not our scenario can be properly modeled by it.
...
% I would say there are roughly 4 categories of academic study: hard sciences, soft sciences, art, and "structural" (math, logic, theoretical computer science, anything totally abstract). Hard and soft science are both the same thing (science). The qualifiers just denote development.
