...
% It was not written with sourcing in mind. I don't consider it to be an "academic work" in the traditional sense of the term.
% All other excuses aside, I honestly just didn't care to go through the trouble.
...
% Thanks to Wikipedia, math.stackexchange, cs.stackexchange, tex.stackexchange, Stack Overflow, Encyclopedia of Mathematics, Stanford Encyclopedia of Philosophy.
...
% Make your own guide!
% Computer science is not about computers. The concepts are everywhere.
% Chapters and sections.
% While jargon is confusing to people who are not 'in the know', it is usually very descriptive. It paints a very precise picture, if you know how to differentiate similar terms. The English words that are used are often quite apt.
...
Although we are initially confused, we naturally pursue an understanding of the chaos that surrounds us. We perceive the goings-on of our environment and draw \textit{information} from them, piecing together a \textit{knowledge} that orients us and gives meaning to the disorder of our existence. This is the crux of computation. It is the structured manipulation of \textit{data} into \textit{information} for the purpose of acquiring \textit{knowledge}. \\

These terms---data, information, and knowledge---are broad enough to apply to nearly any academic field that strives for objectivity. One can have data on, information about, and knowledge of anything that can be observed. In fact, fields that seem quite different may only differ in the kinds of data that are handled. In electrical physics, data is collected on properties like voltage and amperage to give insight into the behavior of electrons. Meanwhile, in linguistics, data is collected on words and phonetic sounds to give insight into the origin, structure, and meaning of language. Common to both disciplines is the computation of answers. \\

% Data can represent anything. The medium it takes on determines what field you are working in. In math, data are numbers, info is theorems. In physics, data are physical properties, info is laws. In logic, data are statements, info are conclusions. In language, data are words, info is semantic meaning.

% Data is syntax, information is semantics?

In this chapter, we will explore what computation is, how it is done, and what it can accomplish. Many physical and mental processes can be viewed through the lens of computation, including the manipulation of numbers, as practiced in mathematics. Other computations may involve the manipulation of time-varying physical phenomena, as practiced in signal processing, the manipulation of truths, as practiced in logic, or the manipulation of words, as practiced in language. We will unify these processes under a general definition before zeroing in on how computation arises in computer science, and, by extension, in software engineering, as the manipulation of \textit{digital state}. \\
...
As stated previously, data are collected by sampling the properties of "phenomena from the observable Universe." It is worth pausing here to consider what this really means. \textit{Phenomena} are omnipresent in reality. They are the things we observe, perceive to exist, or \textit{experience}. There is much philosophical debate about their study, \textit{phenomenology}, to the point that some views differ on a fundamental level. Even basic categorization of the countless phenomena that one can experience in life is difficult because there is no consensus on what exactly experience \textit{is}. \\
...
They exist in the physical realm as \textit{substances}, which have both \textit{form} and \textit{matter}, that . Form, which defines the \textit{properties} of a substance, can be considered separately from matter in the mental realm by means of \textit{abstraction}. This is the approach of mathematics, which seeks to define  \\
...
% The Shannon-Weaver Model (also known as Shannon theory or information theory)
...
%--------------------------------------------------------------------------------
%    APPENDIX B: THE FUTURE OF THIS GUIDE
%--------------------------------------------------------------------------------
