...
% While I was writing this, I found myself using "we" a lot. It just felt natural. We = Me + You, so I guess I should introduce myself to you.
...
% "No one reads the introduction

% https://www.standoutbooks.com/nail-non-fiction-introduction/

% The hook starts here. Why should the reader care?
% There might be many reasons, depending on who you are. <List reasons here?> However, there is a more general reason. We are all...
...
% I begin writing this in such a way that I could understand it. Then, it got big enough that I thought it could be of use to others, so I started to write it in such a way that someone with less formal education than me could understand it. Then, I realized that in order to really get it, I had to write about these complex topics in such a way that someone outside of CS could feasibly understand it, given enough time and drive. This is intuitive understanding.
...
% I'm not a PhD. Most people who write textbooks are. This is still a textbook.
...
This world in which we find ourselves may indeed be post-Chaos, but confusion remains a familiar state for us. In fact, it is our natural state. We come into life confused about everything, crying, open-eyed in reaction to how much is going on around us. Slowly, we figure a few things out. After a few years, we consider quite a few things to be \textit{certain}. Much later, the wise ones among us come to realize the true depth of their confusion. \\

Although we are initially confused, we naturally pursue an understanding of the chaos that surrounds us. We perceive the goings-on of our environment and draw \textit{information} from them, piecing together a \textit{knowledge} that orients us and gives meaning to the disorder of our existence. This is the crux of computation. It is the structured manipulation of \textit{data} into \textit{information} for the purpose of acquiring \textit{knowledge}. It shines a light into darkness we call home. \\

These terms---data, information, and knowledge---are broad enough to apply to a variety of systems. In fact, these terms appear in nearly every academic field and certainly within those that strive for objectivity. One can have data on, information about, and knowledge of anything that can be observed or experienced. As such, it is difficult to confine these terms to short and tidy definitions that are free of controversy. We will have to settle then for long, workable definitions. \\

In this chapter, we will explore what computation is and why it matters. To do this, we will discuss the \textit{things that are computed} and the \textit{laws that computation necessarily follows}. Section 1, \textit{Information and Communication}, \dots. Section 2, \textit{Reasoning and Logic}, \dots. \\

In some sense, computation is a kind of game, where \textit{pieces} are moved and transformed according to a predetermined set of \textit{rules}. Here, we learn how to play. In the next chapter, we learn the limits of what is possible. From , we learn how to be an excellent player.

%Many physical and mental processes can be viewed through the lens of computation, including the manipulation of numbers, as practiced in mathematics. Other computations may involve the manipulation of time-varying physical phenomena, as practiced in signal processing, the manipulation of truths, as practiced in logic, or the manipulation of words, as practiced in language. We will unify these processes under a general definition before zeroing in on how computation arises in computer science, and, by extension, in software engineering, as the manipulation of \textit{digital state}. \\
...
% Metaphysics and categories, phenomena
% Objects and events, properties
% Plato's Forms
% Universals and particulars
% Mathematics is the study of formal phenomena
% Phenomena can include non-physical things, but let's focus on things that are physical (or pure mathematical)

To clear the Chaos, we have to ask what there is. What is there to observe? Objects and events? Waves and particles? Signals? 
...
% Traditionally, physics has been described in terms of particles (classical mechanics, atomic theory). Later, some things were described with waves (aether, classical field theory). Classical mechanics + special relativity = relativistic mechanics. Macroscopic physics is now modeled with relativistic mechanics. It is usually described with Lagrangian/Hamiltonian mechanics/field theories. Modern physics (macro and micro) is described with the Standard Model (quantum mechanics + QFT). This model is imperfect.
...
% In general, outdated models tend to be anthropocentric in scale for space, time, and semantic meaning (theology). However, less general theories are not "broken". They are still useful in certain scenarios.
...
% Quantum mechanics supports object/event metaphysics. Fermions and bosons. Quantum fields of mass and force. Spacetime. Mass-energy.
