...
In his \textit{Theogony}, the Ancient Greek poet Hesiod (fl. 750 BCE) depicts a fascinating uncertainty known as Chaos: a vast nothingness that preceded the creation of the Universe. From this void emerged the primordial deities, personifications of nature who gave birth to the Titans. Curiously, the modern definition of \textit{chaos} has nearly inverted. Now, one might say that a situation is \textit{chaotic} if there is so much going on that it is hard to make sense of anything. Despite their great conceptual difference, these meanings share a common property: they both evoke \textit{confusion}. \\
...
% Computer science is a unifier of academic fields. It is hard to fully grasp because it is so general. We need to pull from many disciplines to characterize it effectively.

%----------------------------------------

\subsection{Metaphysics of Classical Antiquity}

% One could argue that philosophy has been done ever since we could think. But philosophy in Ancient Greece was different. Why?
% Motivation for metaphysics. The One. Henosis. Geography. Democracy.
% Thales. Explaining things without the supernatural. From many things to one substance (water).
...
% Plato is unconcerned with matter. Though he did believe in the classical elements.
% However, Plato does not define substance (data). It abstracts it away. To understand information, we must consider a different metaphysical theory.
