...
So it is through a great deal of concurrent filtering and learning that we come to build a cavern around ourselves. But we do not muffle our perception pointlessly---we trade it for genuine \textit{thought}. There is a distinction that is sometimes made in cognitive science between a \textit{(phenomenal) P-consciousness} and an \textit{(access) A-consciousness}. The former is the sole consciousness of the baby mind, concerned only with bits of immediate, subjective experience known as \textit{qualia} (e.g. what it is like to feel water flowing on your hands \textit{at this moment}, what it is like to taste this \textit{particular} raspberry you are mashing between your molars, etc.). The latter is the dominant consciousness of the adult mind, concerned with anything that has to do with \textit{neural information} (sensory data, memories, abstract ideas, all thoughts that are \textit{about} something). \\
...
% If there were, everything would belong to it, and it would provide no info.
...
% After a while, things start to repeat. You \textit{perceive} them: one here and now, another there and later---and there it is again! You recognize \textit{patterns} in the chaos. In doing so, you also \textit{abstract} away the irrelevant details of what you experience, collate what matters, and construct a \textit{memory}, a description of a pattern or event that is encoded and stored in the brain. \\
...
% Monism and dualism are just simple, broad models or ways of looking at the world
