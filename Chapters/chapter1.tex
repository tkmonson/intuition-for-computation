...
\begin{tcolorbox}[breakable, enhanced, colback=textbook-blue, sharp corners]
	...
	And yet, there is also that deep feeling in us that the mind is something else. We are inclined to believe that there is something about consciousness that is incomparable to, say, a system of ropes and pulleys or a computational system, no matter how complex either may be. Namely, we feel that there is \textit{something that it is like to experience being}. In 1974, Thomas Nagal brought this idea to the attention of the burgeoning field of \textit{cognitive science} with his paper \textit{What Is It Like to Be a Bat?}, in which he states that no physicalist theory will capture the essence of the mind until we come to understand its subjective aspects: \\
	
	\begin{displayquote}
		\textit{The fact that an organism has conscious experience at all means, basically, that there is something it is like to be that organism. There may be further implications about the form of the experience; there may even (though I doubt it) be implications about the behavior of the organism. But fundamentally an organism has conscious mental states if and only if there is something that it is like to \textbf{be} that organism---something it is like \textbf{for} the organism. We may call this the subjective character of experience. \\}
	\end{displayquote}

	This "subjective character of experience" presents a major challenge to the belief that neuroscience will eventually reduce consciousness to a theory. The \textit{philosophy of mind} is then, perhaps, brazenly Postmodernist---inherently subjective and relativistic, with answers that will remain unknown to mankind despite our scientific progress. Nagal posits, for example, that we cannot conceive of the subjective experience of a bat because it is totally alien to our own experience. And further, he argues that it does no good to ground such an experience in greater and greater \textit{objectivity} (i.e. independence from human bias), that such first-person character is stripped away in the third-person framework of science: \\
	
	\begin{displayquote}
		\textit{It will not help to try to imagine that one has webbing on one's arms, which enables one to fly around at dusk and dawn catching insects in one's mouth; that one has very poor vision, and perceives the surrounding world by a system of reflected high-frequency sound signals; and that one spends the day hanging upside down by one's feet in an attic. In so far as I can imagine this (which is not very far), it tells me only what it would be like for \textbf{me} to behave as a bat behaves. But that is not the question. I want to know what it is like for a \textbf{bat} to be a bat.}
		\begin{center}
			\mydots
		\end{center}
		\textit{If the subjective character of experience is fully comprehensible only from one point of view, then any shift to greater objectivity---that is, less attachment to a specific viewpoint---does not take us nearer to the real nature of the phenomenon: it takes us farther away from it. \\}
	\end{displayquote}
	
	Blah
	
	%%% Introduce the problem
	% What is the hard problem of consciousness? Finding a satisfying mechanistic explanation for the way things feel. Subjective experience is linked with a "single point of view" and any outside, objective views would not be able to explain the qualia of that consciousness. Consciousness is not objective.
	
	%%% Define what is considered qualia
	% What kind of things are qualia? Internal and external sensations, emotions, and moods. This is what must be explained.
	
	%%% Philosophical positions that will influence your solution (and challenges to those positions)
	% Physicalism, explanatory gap (objective science does not say anything about subjective experience)
	% Emergentism/reductionism. Does consciousness "emerge" because the whole is greater than the sum of its parts? Or is consciousness reducible to the parts?
	% Representationalism. In contract to direct realism, which assumes that the world that we perceive is the real world, that there is a homunculus that interprets sensory data correctly. Most philosophers of the mind believe that we perceive representations, but not all of what is real. A mental representation is an interpretation of sensory information about a phenomenon (visual data in the wild). It is state. Qualia are traditionally considered to be nonrepresentational, but if they are instead representational, then the state that fully represents an experience must include representations of qualia.
	...
	%%% Some solutions
	% Strong reductionism - consciousness is an emergent property, a rejection of the problem. Higher-order theories suggest that conscious thoughts are thoughts about first-order mental states.
	% Weak reductionism - a dualism of concepts (phenomena and categorical information)
	% Property dualism - physical systems like brains have both physical and mental properties
	% Panpsychism - everything has conscious qualities (minds), it is a fundamental property of matter
	
	% Mary the color scientist - does she learn anything through sheer experience that she cannot learn through study? If she learns something, qualia exist and physicalism is false.
...
% Agency/intensionality/primitive causality, object representation, and means/ends dichotomy at 4-5 months
% Object permanence at 8 months (maybe 3...)
% Thought (hypothesis-forming) at about 9 months
% Until about 12 months, they only perceive objects, nothing more specific. They do not understand properties until 12 months.
% Self-awareness at 15 months.
% Symbolic thought at 18 months
% Class inclusion at 3 years
% Realistic metaphysical views possible at 7 years
% Abstract concepts at 12

% Patterns, mathematics is the study of patterns

% Infants understand objects (continuous, spatiotemporal boundaries) before they understand properties (differing features). True?
...
% Arche (first principle, element, the nature). Philosophy was born in asking what the nature of things was
...
% The Christian Trinity is based off Plotinus' interpretation of Plato: the Father is the One/Good (the possibility of existence), the Son is the Nous (the intelligence of God or the Demiurge, abstract thought, structure instead of chaos, the actualization (energeia) of these thoughts are the Forms), and the Holy Spirit is the Soul (the world soul, the collective phenomenal consciousness, the fire of life, the actuality of existence). The Nous perceives and causes the One to manifest Soul as energy.
