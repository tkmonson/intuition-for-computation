...
\begin{tcolorbox}[breakable, enhanced, colback=textbook-blue, sharp corners]
	...
	% Metaphysical naturalism becomes popular because of science (quantum mechanics, theory of computation, information theory)
	% People start to believe that the mind is computational and physical
	% Nagal's paper challenges physicalism in cognitive science
	...
	% Representationalism. A mental representation is an interpretation of sensory information about a phenomenon (visual data in the wild). It is state. Qualia are traditionally considered to be nonrepresentational, but if they are instead representational, then the state that fully represents an experience must include representations of qualia.
	...
	% Mary the color scientist - do she learn anything through sheer experience that she cannot learn through study? If she learns something, qualia exist and physicalism is false.
