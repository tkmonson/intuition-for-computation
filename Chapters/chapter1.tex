...
\begin{description}
	\item[Section 1:] \textit{Information}
	\item[Section 2:] \textit{Communication}
	\item[Section 3:] \textit{Logic} \\
\end{description}
...
This is roughly the experience of a newborn infant. For children of only a month or so, life is a sensory mayhem of little sense. They are not conscious, at least not in the way that we typically think of consciousness. They are, however, aware of their surroundings and sensitive to \textit{phenomena} (i.e. \textit{appearances} in reality, \textit{observables}). To newborns, the world is not a system of distinct parts but an all-encompassing soup of stimuli. Their sensory organs input data that they do not understand, and they then output \textit{reflexes} that have been embedded in their biological firmware due to millions of years of natural selection. \\
...
% Why is all this qualia stuff important for CS?
	...
	% But in any universe, we consider things: everything (inf), something (1), or nothing (0).
	% Hofstadter
	% Formal systems
...
% However, they bring up a few important philosophical concepts:
	% Subject (agency) and Object
	% Identity and Individuation
	% Map-territory relation
	% Essence and existence
	
% There are also important concepts for the objective realm in particular:
	% Causality
	% Space and time
	
% Objective, perceptual, and conceptual universes
% Everything, something, nothing (infinity, 1, 0)
% Closed-world, open-world, DoD
% We must consider open-worlds before we discuss closed-worlds.
% Natural and constructed systems.

% What is a ceramic mug to my perception? What is it to my conception? How would I categorize it (depends on context)?
